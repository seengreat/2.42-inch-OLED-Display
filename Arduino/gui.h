...
void GUI_ShowChar(u16 x,u16 y,u8 chr,u16 fontcolor,u16 bkcolor,u8 size1,DOT_PIXEL Dot_Pixel, DOT_STYLE Dot_Style);
void Oled_ShowString(u8 x, u8 y, u8 *chr, u8 size1, u16 fontcolor,u16 bkcolor);
